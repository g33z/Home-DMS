const documentTags = [
    ...
    "diagnosis", "treatment-plan", "insurance-claim", "vehicle-registration", "vehicle-title", "warranty",
    "product-manual", "repair-invoice", "service-contract", "shipping-label", "packing-slip", "order-confirmation",
    "purchase-order", "sales-invoice", "delivery-note", "timecard", "paystub", "employment-contract",
    ...
    "fundraising-report", "event-plan", "event-agenda", "photograph", "certificate-of-appreciation",
    ...
    "pension-plan", "retirement-statement", "health-benefit-statement", "fitness-plan",
    ...
    "it-equipment", "hardware-spec", "system-configuration", "backup-log", "incident-log",
